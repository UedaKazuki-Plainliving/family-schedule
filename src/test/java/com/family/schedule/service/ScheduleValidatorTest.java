...
class ScheduleValidatorTest {
    ...
    void 正常リクエストはエラーなし() {
        Map<String, String> e = ScheduleValidator.validate(
                new ScheduleRequest(3, LocalDate.of(2026, 4, 24), "塾"));
    ...
    void content_空文字はエラー() {
        Map<String, String> e = ScheduleValidator.validate(
                new ScheduleRequest(1, LocalDate.now(), ""));
    ...
    void content_100文字は境界OK() {
        ...
        Map<String, String> e = ScheduleValidator.validate(
                new ScheduleRequest(1, LocalDate.now(), s));
        assertThat(e).isEmpty();
    }
    ...
    void memberId_未指定はエラー() {
        Map<String, String> e = ScheduleValidator.validate(
                new ScheduleRequest(null, LocalDate.now(), "foo"));
    ...
    void memberId_範囲外はエラー() {
        Map<String, String> e = ScheduleValidator.validate(
                new ScheduleRequest(99, LocalDate.now(), "foo"));
    ...
    void date_未指定はエラー() {
        Map<String, String> e = ScheduleValidator.validate(
                new ScheduleRequest(1, null, "foo"));
